...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240421_constructionsites_58891f56b43125124273_20240421144933_archive.zip';
        const ARCHIVE_SIZE       = '210281243';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '58891f5-21144933';
        const SECONDARY_PACKAGE_HASH = 'f81fec6-21144933';
        const VERSION            = '1.5.9';
